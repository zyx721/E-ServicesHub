...
class AppLocalizations {
  ...
  String get takePicture => isArabic
      ? "التقاط صورة"
      : (isFrench ? "Prendre une photo" : "Take a picture");
  String get retake =>
      isArabic ? "إعادة التقاط" : (isFrench ? "Reprendre" : "Retake");
  String get upload => isArabic ? "رفع" : (isFrench ? "Télécharger" : "Upload");
  String get uploading => isArabic
      ? "جاري الرفع..."
      : (isFrench ? "Téléchargement..." : "Uploading...");
  String get uploadSuccess => isArabic
      ? "تم الرفع بنجاح"
      : (isFrench ? "Téléchargement réussi" : "Upload Successful");
  String get uploadFailed => isArabic
      ? "فشل الرفع"
      : (isFrench ? "Échec du téléchargement" : "Upload Failed");
