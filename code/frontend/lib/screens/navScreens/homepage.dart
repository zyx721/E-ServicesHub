...
class _HomePageState extends State<HomePage> {
  ...
  Widget _buildStarRating(double rating) {
    ...
    return Row(
      children: [
        ...List.generate(fullStars, (index) => Icon(Icons.star, color: Colors.amber, size: 16)),
        if (halfStars > 0) Icon(Icons.star_half, color: Colors.amber, size: 16),
        ...List.generate(emptyStars, (index) => Icon(Icons.star_border, color: Colors.amber, size: 16)),
      ],
    );
  }
