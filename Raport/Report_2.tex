...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\linewidth]{images.jpg}
\end{figure}
\begin{center}
\begin{LARGE}
...
\begin{figure}[ht]
    \begin{center}
        \includegraphics[scale=0.9]{home.png}
...
\begin{figure}[ht]
    \begin{center}
        \includegraphics[scale=0.1]{fir.jpg}
...
\begin{figure}[ht]
    \begin{center}
        \includegraphics[scale=0.5]{ang1.jpg}
         \includegraphics[scale=0.1]{ang2.jpeg}
     \end{center}
\end{figure}
\subsection*{Definition}
